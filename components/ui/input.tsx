  ...
  `,
    {
        variants: {
            variant: {
                lg: "h-10 px-4 text-sm file:me-4 file:pe-4",
                md: "h-9 px-3 text-sm file:me-3 file:pe-3",
                sm: "h-8 px-2.5 text-xs file:me-2.5 file:pe-2.5",
            },
        },
        defaultVariants: {
            variant: "md",
    ...
    "flex shrink-0 items-center justify-center border border-input bg-muted text-secondary-foreground shadow-[rgba(0,0,0,0.05)] shadow-xs [&_svg]:text-secondary-foreground/60",
    {
        variants: {
            variant: {
                ...
                sm: "h-8 min-w-7 px-2.5 text-xs [&_svg:not([class*=size-])]:size-3.5",
            },
            mode: {
                default: "",
