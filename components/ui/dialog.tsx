    ...
    return (
        <DialogPortal>
            ...
            >
                {children}
                {showCloseButton && (
                    <DialogClose className="absolute end-5 top-5 cursor-pointer opacity-60 outline-0 ring-offset-background transition-opacity hover:opacity-100 focus:outline-hidden disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
