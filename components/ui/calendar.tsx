        ...
        <DayPicker
            ...
            classNames={{
                ...
                button_previous: cn(
                    ...
                    "size-5 select-none fill-neutral-200 p-0 text-neutral-200 aria-disabled:opacity-50",
            ...
            components={{
                Chevron: (props) => {
                    if (props.orientation === "left") {
                        return (
                            <RiArrowLeftSLine className="h-4 w-4 rtl:rotate-180" />
                        );
                    }
                    return (
                        <RiArrowRightSLine className="h-4 w-4 rtl:rotate-180" />
                    );
                },
            }}
