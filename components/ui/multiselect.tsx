    ...
    return (
        ...
        >
            ...
            >
                <div className="flex flex-wrap gap-1">
                    {selected.map((option) => (
                        <div
                            className={cn(
                                "relative inline-flex h-7 animate-fadeIn cursor-default items-center border bg-background ps-2 pe-7 pl-2 font-medium text-secondary-foreground text-xs transition-all hover:bg-background disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 data-fixed:pe-2",
                                badgeClassName
                            )}
                        ...
                        >
                            ...
                            <button
                                aria-label="Remove"
                                className="-inset-y-px -end-px absolute flex size-7 items-center justify-center border border-transparent p-0 text-muted-foreground/80 outline-none outline-hidden transition-[color,box-shadow] hover:text-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50"
                                ...
                                type="button"
                            >
                                <RiCloseLine aria-hidden="true" size={14} />
                            </button>
                        </div>
                    ))}
                    ...
                    <button
                        ...
                        className={cn(
                            "absolute end-0 top-0 flex size-9 items-center justify-center border border-transparent text-muted-foreground/80 outline-none transition-[color,box-shadow] hover:text-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50",
                            (hideClearAllButton ||
                                disabled ||
                                selected.length < 1 ||
            ...
            <div className="relative">
                <div
                    className={cn(
                        "absolute top-2 z-10 w-full overflow-hidden border border-input",
