      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        <div className="text-center mb-20 px-4">
          <div className="flex items-center justify-center space-x-4 mb-6">
            <div className="w-8 sm:w-16 h-px bg-gradient-to-r from-transparent to-white/30" />
            <span className="text-xs tracking-[0.3em] text-white/60">FEATURES</span>
            <div className="w-8 sm:w-16 h-px bg-gradient-to-l from-transparent to-white/30" />
          </div>

          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-argesta font-bold mb-6">
