            ...
            <section className="min-h-screen bg-gradient-to-br from-pure-black to-neutral-950 pt-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                    ...
                    <div className="text-center mb-16">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold font-argesta text-white mb-6">
                            Choose Your Path.
                        </h1>
                        <ShinyText
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16">
                        ...
                        <div className="relative bg-gradient-to-br from-purple-500/20 to-purple-600/10 backdrop-blur-sm border-2 border-purple-500/60 rounded-2xl p-6 sm:p-8 md:p-10 hover:border-purple-500/80 transition-all duration-300 transform hover:scale-105 md:col-span-2 lg:col-span-1 lg:scale-110 lg:z-10">
                ...
                <div className="mt-20 w-full px-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-white text-center mb-8">What our users say</h2>
                    <InfiniteMovingCards
                        items={testimonials1}
                        direction="left"
                        speed="slow"
