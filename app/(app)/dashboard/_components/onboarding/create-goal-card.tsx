...
import { RiAddLine, RiSparklingLine, RiSquareFill } from "@remixicon/react";
...
export function CreateGoalCard() {
  ...
  const { mutateAsync: createGoals, isPending: isCreatingGoals } = useMutation(
      ...
      <SpotlightCard className="group border border-white/10 p-0">
        <div className="flex h-full flex-col p-6">
          ...
          <p className="mb-6 flex-1 text-sm text-white/60 leading-relaxed">
            Create your first goal to start building your objectives knowledge
            base.
          </p>
          <div className="flex flex-col gap-3">
            ...
            >
              ...
              {isCreatingGoals ? "Generating..." : "Generate example"}
            </Button>
          </div>
        </div>
      </SpotlightCard>
