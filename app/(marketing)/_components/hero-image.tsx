...
export function HeroImage() {
    ...
    return (
        <div className="relative mt-12 aspect-4/3 w-full bg-neutral-800 sm:mt-16 sm:aspect-video">
            <div className="-top-5 -translate-x-1/2 sm:-top-6 absolute left-1/2 z-30 flex items-center justify-center gap-1.5 border border-neutral-800 bg-background px-2 py-1.5 sm:gap-3 sm:px-3 sm:py-2">
                {MENU_ITEMS.map((item, index) => (
                    <button
                        className={cn(
                            "flex cursor-pointer items-center gap-1.5 px-2 py-1.5 text-xs ring-1 ring-neutral-800 sm:gap-2.5 sm:px-3 sm:py-2",
                            "whitespace-nowrap hover:bg-neutral-800",
