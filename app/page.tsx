  ...
  return (
    <>
      ...
      <section className="h-screen w-full flex items-center justify-center bg-cover bg-center bg-no-repeat relative overflow-hidden grayscale ">
        ...
        <div className="absolute left-8 top-1/2 transform -translate-y-1/2 space-y-8 opacity-60 z-20 hidden lg:flex flex-col">
        ...
        <div className="absolute right-8 top-1/2 transform -translate-y-1/2 space-y-8 opacity-60 z-20 hidden lg:flex flex-col items-end">
        ...
        <div className="absolute top-20 left-20 w-4 h-4 border border-white opacity-20 rotate-45 z-20 hidden md:block"></div>
        <div className="absolute top-32 right-32 w-6 h-6 border border-white opacity-15 rotate-12 z-20 hidden md:block"></div>
        <div className="absolute bottom-40 left-40 w-3 h-3 bg-white opacity-10 rounded-full z-20 hidden md:block"></div>
        <div className="absolute bottom-60 right-20 w-8 h-8 border border-white opacity-25 rotate-45 z-20 hidden md:block"></div>
        ...
        <div className="text-pure-white relative overflow-hidden flex items-center justify-center flex-col z-30">
          <div className="flex items-center justify-center flex-col z-10">
            <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[13vw] bg-gradient-to-b from-white to-gray-400 bg-clip-text text-transparent opacity-90 select-none pointer-events-none whitespace-nowrap font-argesta leading-none">
              ALTIORA
            </h1>

            <ShinyText
              text="Personal coaching platform: trading, habits, and goals in one place."
              className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-[1vw] font-bold text-pure-white opacity-90 select-none pointer-events-none text-center px-4 -mt-2 mb-2"
              speed={8}
            />

            <BlurText
              text="Your discipline, our platform."
              className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-[1vw] text-pure-white opacity-90 select-none pointer-events-none text-center px-4 -mt-2"
            />
          </div>
