...
export const GoalRemindersService = {
  ...
  sendDiscordReminder: async (
    ...
    try {
      ...
      console.info(`Reminder sent to ${discordId} for goal: ${goal.title}`);
    } catch (error) {
  ...
  updateNextReminderDate: async (
    ...
    try {
      ...
      const nextDate = calculateNextReminderInTimezone(frequency, userTimezone);
  ...
  scheduleReminder: async (
    ...
    try {
      ...
      const nextDate = calculateNextReminderInTimezone("daily", userTimezone);
