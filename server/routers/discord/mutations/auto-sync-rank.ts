...
export const autoSyncRankBase = protectedProcedure;

export const autoSyncRankHandler = autoSyncRankBase.handler(
  async ({ context }) => {
    ...
    try {
      await DiscordService.autoSyncUserRank(userData.discordId, userData.rank);
