...
export const getGoalByIdValidator = z.object({
    id: z.string(),
});
...
export const getGoalsPaginatedValidator = z.object({
    ...
    sortBy: z
        .enum(["title", "createdAt", "deadline", "sortOrder"])
        .default("sortOrder"),
...
export const getGoalsByTypeValidator = z.object({
    type: z.enum(["annual", "quarterly", "monthly"]),
});

export const getUpcomingDeadlinesValidator = z.object({
...
export const markTaskCompletedValidator = z.object({
    taskId: z.string(),
    isCompleted: z.boolean(),
});

export const reorderGoalsValidator = z.object({
