...
export const metatraderWebhookPayloadSchema = z.object({
    ...
    position_id: z
        .number()
        .int()
        .positive("Position ID must be a positive integer"),
...
export type MetaTraderWebhookPayload = z.infer<
    typeof metatraderWebhookPayloadSchema
>;
...
export type GenerateWebhookTokenInput = z.infer<
    typeof generateWebhookTokenSchema
>;
