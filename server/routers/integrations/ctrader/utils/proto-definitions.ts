		...
		OpenApi: {
			nested: {
				...
				ProtoOAGetAccountListByAccessTokenRes: {
					fields: {
						accessToken: { type: "string", id: 2 },
						permissionScope: { rule: "repeated", type: "ProtoOAPermissionScope", id: 3 },
						ctidTraderAccount: {
							rule: "repeated",
				...
				ProtoOAReconcileRes: {
					fields: {
						ctidTraderAccountId: { type: "int64", id: 2 },
						position: { rule: "repeated", type: "ProtoOAPosition", id: 3 },
				...
				ProtoOAPosition: {
					fields: {
						...
						positionStatus: { type: "ProtoOAPositionStatus", id: 3 },
				...
				ProtoOADeal: {
					fields: {
						...
						closePositionDetail: { type: "ProtoOAClosePositionDetail", id: 16 },
				...
				ProtoOAGetTrendbarsRes: {
					fields: {
						...
						trendbar: { rule: "repeated", type: "ProtoOATrendbar", id: 4 },
						symbolId: { type: "int64", id: 5 },
					},
				},
				ProtoOATrendbar: {
